...
from freenodes.web import Page
...
@pytest.mark.parametrize(
    ...
    (
        (
            "资源地址：https://paste.to/?3c4d47bd5fa1f66a#BwJn7AXEmdXR88rdRZyY7JXjKrmd8NgcjVwU2SiwroVf",
            "https://paste.to/?3c4d47bd5fa1f66a#BwJn7AXEmdXR88rdRZyY7JXjKrmd8NgcjVwU2SiwroVf",
        ),
        (
            "https://www.youtube.com/redirect?event=video_description&redir_token=fixture&q=https%3A%2F%2Fpaste.to%2F%3Ffixture%23secret&v=fixture",
            "https://paste.to/?fixture#secret",
        ),
        ("https://example.com", None),
        ("https://paste.to/?fixture", None),
        (
...
def test_paste_url_grammar_requires_a_decryption_fragment(text, expected):
    assert extract_paste_url(text) == expected
