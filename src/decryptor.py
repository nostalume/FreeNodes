"""Typed, source-scoped browser ownership for protected resources."""
...
from src.config import FrozenModel, PasswordCandidates
from src.crawler import Page, PageLink
